...
export const Hero = () => {
  return <div className="text-white bg-[linear-gradient(to_bottom,#000,#200D42_34%,#4F21A1_65%,#A46EDB_82%)] py-[72px] sm:py-24 relative overflow-clip">
    <div className='absolute h-[375px] w-[750px] sm:w-[1536px] sm:-[768px] rounded-[100%] bg-black left-1/2 -translate-x-1/2 broder-[#B48CDE] bg-[radial-gradient(closest-side,#000_82%,#9560EB)] top-[calc(100%-96px) sm:top-[calc(100%-120px)] lg:w-[2400px] lg:h-[1200px]'>
    </div>
